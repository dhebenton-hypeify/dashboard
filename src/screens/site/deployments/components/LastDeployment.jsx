    ...
    return (
        <Card style="last-deployment-card sites-card-fade-up f-col g24 flex9 can ">
            ...
            <div className="f-row flex g14">
                <img src={"https://ommbbnhzostnosfvgfjy.supabase.co/storage/v1/object/public/site-thumbnails/thumbnails/f4fe3d67-1128-4126-9796-cb4871afc53a.png"} alt="" className="site-card-thumbnail trans deployments-card" />
                <div className="f-col flex g14">
                    ...
                    <Card style="f-col g32">
                        ...
                        <div className="f-row j-s-b f-wrap g20">
                            <div className="f-row last-deployment-last-stat flex j-s-b f-wrap g20">
                            ...
                            <div className="f-row flex last-deployment-last-stat j-s-b f-wrap g20">
                                <div className="f-col  flex a-f-s g14">
